<?php
define('C_REST_CLIENT_ID','local.69e0a72206d861.38982486');//Application ID
define('C_REST_CLIENT_SECRET','bS60EwDNCSH0jyUvaQ4gocX0SqgFivjdm8RNmDh3ebeurbn8mF');//Application key
// or
