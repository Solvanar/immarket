<?php
define('C_REST_CLIENT_ID','local.69e20745ede2c1.68019568');//Application ID
define('C_REST_CLIENT_SECRET','8BUoBgh6KmlFZwWD2m5Ih75RBVDTyzMMeRYEtsI8bv0cT4AhOM');//Application key
// or
