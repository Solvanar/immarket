<?php
define('C_REST_CLIENT_ID','local.69e0aa680f4cc5.24139748');//Application ID
define('C_REST_CLIENT_SECRET','AjoQjO6Z46rBaYzQPQ7b1zOYpXnbf4IqHyExpfPwiGJDi8RelV');//Application key
// or
