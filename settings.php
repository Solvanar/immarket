<?php
define('C_REST_CLIENT_ID','local.69e0b0f659a758.41700726');//Application ID
define('C_REST_CLIENT_SECRET','NBbvoTvLpfPZoGzRSJJxw6wqnDPQnF0Hl3mdDrTczWpEQbHf8x');//Application key
// or
